...
import br.com.srbarriga.utils.reports.ExcelReport;
import br.com.srbarriga.utils.reports.Query;
import br.com.srbarriga.utils.reports.model.TestData;
...
public class GenerateEvidenceReport {
	...
	public static void generatePDFEvidence(List<SeleniumEvidence> list, String reportName, String tester,
		...
		try {
			...
			String companyImage = System.getProperty("user.dir") + properties.getProperty("image.company.path");
